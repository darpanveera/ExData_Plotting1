plot4 <- function(){
  ...
  #Create a PNG file with 480/480 Pixel and save it using a plot with 4 miltiple plots
  png(filename = "C:/Darpan/DataScience/Course4/Week1/plot4.png",width = 480, height = 480)
 ...
 with(hhpcsubsetdf, {
  ...
  plot(as.POSIXct(paste(hhpcsubsetdf$Date,hhpcsubsetdf$Time)),hhpcsubsetdf$Voltage, type="l", xlab="datetime", ylab = "Voltage")
  ...
  plot(as.POSIXct(paste(hhpcsubsetdf$Date,hhpcsubsetdf$Time)),hhpcsubsetdf$Global_reactive_power, type="l", xlab="datetime", ylab = "Global_reactive_power")
 })
  dev.off()
